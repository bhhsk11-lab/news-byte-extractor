...
print('SELF TEST: Chromium navigation API timeout = 0; Chromium resolver budget = 20 seconds')
print('SELF TEST: whole staged resolver has no global timeout; Chromium-only budget = 20 seconds')
print('SELF TEST: Chromium resolver stops after 20 seconds if no publisher URL is found')
